...
const OPERATION_TO_METHOD: Record<string, string> = {
  ...
  "GET /api/v1/admin/gallery": "listAdminGallery",
  "POST /api/v1/admin/gallery": "createGalleryItem",
  "DELETE /api/v1/admin/gallery/{gallery_id}": "deleteGalleryItem",
  "GET /api/v1/admin/gallery/{gallery_id}": "getAdminGallery",
  "PATCH /api/v1/admin/gallery/{gallery_id}": "updateGalleryItem",
  ...
  "GET /api/v1/gallery": "listGallery",
